...
public class Project extends Model {
	...
	public static Project create(String name, String folder, String ownerId) {
		Project project = new Project(name, folder, User.find.where().eq("email", ownerId).findUnique());
		project.save();
		return project;
	}
